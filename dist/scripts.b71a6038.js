...
},{"./key_stores/browser-index":"../node_modules/near-api-js/lib/key_stores/browser-index.js","./common-index":"../node_modules/near-api-js/lib/common-index.js","./browser-connect":"../node_modules/near-api-js/lib/browser-connect.js","error-polyfill":"../node_modules/error-polyfill/index.js"}],"near/config.js":[function(require,module,exports) {
// Once you deploy the contract to its final account, make sure to specify it here
var CONTRACT_NAME = "lottery.timthang.testnet";
...
},{}],"near/utils.js":[function(require,module,exports) {
var define;
"use strict";
...
var nearConfig = (0, _config.default)(); // Initialize contract & set global variables
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("#####################");
            console.log("INITCONTRACT 1");
            console.log("#####################"); // Initialize connection to the NEAR testnet
          ...
          case 5:
            ...
            console.log("#####################"); // Initializing Wallet based Account. It can work with NEAR testnet wallet that
            // is hosted at https://wallet.testnet.near.org

            window.walletConnection = new _nearApiJs.WalletConnection(near);
            console.log("#####################");
            console.log("INITCONTRACT 3");
            console.log("#####################"); // Getting the Account ID. If still unauthorized, it's just empty string

            window.accountId = window.walletConnection.getAccountId();
            console.log("#####################");
            console.log("INITCONTRACT 4");
            console.log("#####################"); // Initializing our contract APIs by contract name and configuration
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return window.contract.getInfo({
              args: {}
            }).catch(function (err) {
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"near/config.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
function signedOutFlow() {
  document.querySelector('.sign-in').style.display = 'block';
  document.querySelectorAll('.interact').forEach(function (button) {
...
function _signedInFlow() {
  _signedInFlow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
},{"./near/utils":"near/utils.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
